...
public class EstudianteServicio implements IEstudianteServicio{
    ...
    @Override
    public List<Estudiantes2022> listarEstudiantes() { //Método listarEstudiantes 
    ...
    public Estudiantes2022 buscarEstudiantePorId(Integer idEstudiantes2022) {
        Estudiantes2022 estudiante = estudianteRepositorio.findById(idEstudiantes2022).orElse(null); // findById es opcional si no recibe el id o regresa en este caso un null
        return  estudiante;
    }
