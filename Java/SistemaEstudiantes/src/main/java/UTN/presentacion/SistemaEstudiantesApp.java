...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        ...
        var consola = new Scanner(System.in); //Para leer informción de la consola
        //Se crea una instanca de la clase servcio, esto lo hacemos fuera del ciclo
        var estudianteDao = new EstudianteDAO();//Esta instancia debe hacerse una vez
        while(!salir) {
            try {
                mostrarMenu();//Mostramos el meu
    ...
    //Método para ejecutar las opciones, va a regresar un valor booleaano, ya que es el que
    //puede modificar el valor de la variable salir, si es veraddero termia el ciclo while
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDao) {
        ...
        switch(opcion) {
            ...
            case 5 -> {//Eliminar estudiante
                ...
                if(eliminado)
                    System.out.println("Eliminar eliminado: "+estudiante);
